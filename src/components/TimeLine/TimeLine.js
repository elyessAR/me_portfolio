...
const Timeline = () => {
  ...
  return (
    <Section id="about">
      ...
      <SectionText>
        Experienced software engineer with expertise in full stack development, Database management, rest API's creation, security and frontend
        development. Proficient with various frameworks and libraries. Able to work independently on projects, as well as collaborate with as a part
        of team when needed
      </SectionText>
